...
SECRET_KEY = 'django-insecure-(!!&g*j58qvbde6@5if52e(%k*2i10_zu(pmk2mghmx0=m#!ya'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR / "templates")],   # changed for authentication
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if 'test' in sys.argv:
    # Use a separate test database to prevent messing with the development or production database.
    DATABASES['default'] = {
        'ENGINE': 'django.db.backends.sqlite3',
    ...
    # Use a simplified logging configuration during tests
    LOGGING = {
        'version': 1,
    ...
    # Use the minimal password validation during tests
    AUTH_PASSWORD_VALIDATORS = [
        {
            'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator',
            'OPTIONS': {
